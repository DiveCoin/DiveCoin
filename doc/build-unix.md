UNIX BUILD NOTES
====================
Some notes on how to build DiveCoin in Unix. 
...
memory available when compiling DiveCoin Core. With 512MB of memory or less
...
If you want to build DiveCoin-Qt, make sure that the required packages for Qt development
...
# Configure DiveCoin Core to use our own-built instance of BDB
cd $DASH_ROOT
...
Security
--------
To help make your DiveCoin installation more secure by making certain attacks impossible to
