...
[From the divecoin github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
## What about the divecoin.conf file?

If you are using a masternode.conf file you no longer need the divecoin.conf file. The exception is if you need custom settings (thanks oblox). 

## Update divecoin.conf on server

If you generated a new masternode private key, you will need to update the remote divecoin.conf files.

Shut down the daemon and then edit the file.

```sudo nano .divecoin/divecoin.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote divecoin.conf file.
