...
##perform gitian builds
 ...
 Build divecoind and divecoin-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit divecoin=v${VERSION} ../divecoin/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../divecoin/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r divecoin-${VERSION}-linux-gitian.zip *
	mv divecoin-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit divecoin=v${VERSION} ../divecoin/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../divecoin/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r divecoin-${VERSION}-win-gitian.zip *
	mv divecoin-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit divecoin=v${VERSION} ../divecoin/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
