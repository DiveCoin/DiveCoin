...
It is possible to run DiveCoin as a Tor hidden service, and connect to such services.
...
The first step is running DiveCoin behind a Tor proxy. This will already make all
