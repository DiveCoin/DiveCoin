...
/* *** BEGIN DARKSEND MAGIC - DASH **********
    Copyright (c) 2014-2015, DiveCoin Developers
        eduffield - evan@divecoinpay.io
        udjinm6   - udjinm6@divecoinpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat DiveCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("divecoin-darksend");
