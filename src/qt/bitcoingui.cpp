    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DiveCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DiveCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and divecoin: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About DiveCoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About DiveCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DiveCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DiveCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DiveCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DiveCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a divecoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the DiveCoin Core help message to get a list with possible DiveCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("DiveCoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("DiveCoin client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DiveCoin network", "", count));
}
...
{
    QString strTitle = tr("DiveCoin"); // default title
